...
class TrainConfig(Config):
    ...
    pretrained_weights = Config.pretrained_weights #'./weights/model_12.pth'
...
def main():
    ...
    parser.add_argument('--load', default=None, help='path for pretrained model')
    ...
    if args.command == 'train':
        ...
        config.pretrained_weights = args.load
